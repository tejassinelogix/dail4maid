                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{ route('admin.profile') }}"><i class="fa fa- user"></i>{{ __('msg.profile') }}</a>

                            <!--<a class="nav-link" href="{{ route('admin.dashboard') }}"><i class="fa fa- user"></i>{{ __('msg.my account') }}</a>-->

                            <a class="nav-link" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();><i class="fa fa-power -off"></i>{{ __('msg.Logout') }}</a>
